...
public class BaseClient : IDisposable
{
    ...
    /// </summary>
    public string Name => Object != null ? Object.Nickname : UnknownName;
    ...
    /// <summary>
    /// Gets the current position of the client.
    /// </summary>
    ...
    public bool Reconnect(string serverName, float timeOffset = 0f, string message = null)
    {
        ...
        Logger.Info($"{Tag} Server (f=yellow){Server.Name}(f=white) {message}, reconnect in (f=yellow){timeOffset}(f=white) seconds", "Client");
    ...
    public bool ProcessMirrorMessageFromListener(ushort id, NetworkReader reader)
    {
        switch (id)
        {
            ...
            case NetworkingMessages.SSSClientResponse:
            ...
            case NetworkingMessages.ReadyMessage:
                ...
                IsReady = true;
                Logger.Info("[CLIENT] ReadyMessage");
                break;

            case NetworkingMessages.AddPlayerMessage:
                Server?.OnClientSpawnPlayer(this);
                Logger.Info("[CLIENT] AddPlayerMessage");
                break;

            case NetworkingMessages.CommandMessage:
                ...
                if (World != null && World.Objects.TryGetValue(commandMessage.netId, out SpawnableObject spawnedObject))
                {
    ...
    public bool ProcessMirrorMessageFromServer(ushort id, NetworkReader reader)
    {
        switch (id)
        {
            case NetworkingMessages.RoundRestartMessage:
            ...
            case NetworkingMessages.RoleSyncInfo:
                ...
                if (NetworkIdentityId == entityId && !IsSpawned)
                {
                    ...
                    IsSpawned = true;
                    Logger.Info("[SERVER] Client spawned");
                }
                break;
            ...
            case NetworkingMessages.SpawnMessage:
                ...
                switch (spawnMessage.assetId)
                {
                    ...
                    case 3816198336:
                        ...
                        {
                            Object = new PlayerObject(this, spawnMessage.netId);
                            NetworkIdentityId = spawnMessage.netId;
                        }
                        break;
                    // ConfigSync
                    case 180257209:
                        if (spawnMessage.sceneId != 3656837585730004444)
                            break;

                        ConfigSync = new ConfigSyncObject(null);
    ...
    public void SendServerSpecificEntries(ServerSpecificSettingBase[] entires)
    {
        ...
        wr.WriteUShort(NetworkingMessages.SSSEntriesPack);
        packed.Serialize(wr);
    ...
    {
        NetworkWriter wr = new NetworkWriter();
        wr.WriteUShort(NetworkingMessages.RoleSyncInfo);
    ...
    public void DestroyObject(uint networkIdentityId)
    {
        ...
        wr.WriteUShort(NetworkingMessages.ObjectDestroyMessage);
        wr.WriteUInt(networkIdentityId);
    ...
    public void FastRoundrestart()
    {
        ...
        wr.WriteUShort(NetworkingMessages.RoundRestartMessage);
    ...
    public void SendToScene(string sceneName)
    {
        ...
        wr.WriteUShort(NetworkingMessages.SceneMessage);
    ...
    public void SetSeed(int seed)
    {
        ...
        wr.WriteUShort(NetworkingMessages.SeedMessage);
    ...
    {
        NetworkWriter wr = new NetworkWriter();
        wr.WriteUShort(NetworkingMessages.StatMessage);
    ...
    /// </summary>
    public Action<BaseClient, Server, BaseResponse> ConnectionResponse;
    ...
    public void InvokeConnectionResponse(Server server, BaseResponse response)
    {
        switch (response)
        {
    ...
    public void Disconnect(string message = null)
    {
        if (Request == null)
        {
            if (message != null)
            {
                ...
                NetworkWriter wr = new NetworkWriter();
                wr.WriteUShort(NetworkingMessages.RpcMessage);
                wr.WriteUInt(NetworkIdentityId);
                wr.WriteByte(1);

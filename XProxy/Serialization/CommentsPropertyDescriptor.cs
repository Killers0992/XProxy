...
{
    internal sealed class ConsoleCommentsPropertyDescriptor : IPropertyDescriptor
    {
        public ConsoleCommentsPropertyDescriptor(IPropertyDescriptor baseDescriptor)
        {
        ...
        public IObjectDescriptor Read(object target)
        {
            ...
            return new ConsoleCommentsObjectDescriptor(this._baseDescriptor.Read(target), customAttribute.Description);
        }
